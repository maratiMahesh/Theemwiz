...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center p-4 text-white md:px-16'>
      <div>
        <img src="/Images/logo.png" alt="Logo" className="h-12 w-15 object-contain " />
      </div>
      ...
      <div className="flex flex-col md:hidden items-center space-x-4">
        <img src="/Images/menu.png" alt="Logo" className="h-10 w-12 object-contain " onClick={handleMenuToggle}/>
      </div>
