    ...
    <div className='bg-gray-800 p-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-5 gap-4 mt-8 px-16 '>
            <div className=' relative md:col-span-2'>
                ...
                <img src="/Images/Bitmap1.png" alt="Portfolio Item" className=' w-full h-60 md:h-80  object-cover rounded-lg shadow-lg' />
                </div>
            <div className='relative md:col-span-3 '>
                ...
                <img src="/Images/Bitmap2.png" alt="Portfolio Item" className=' w-full h-60 md:h-80 object-cover rounded-lg shadow-lg' />
                </div>
                <div className='relative md:col-span-3 '>
                    <div className='absolute bottom-8 left-4 bg-opacity-80'>
                ...
                <img src="/Images/Bitmap3.png" alt="Portfolio Item" className=' w-full h-60 md:h-80  object-cover rounded-lg shadow-lg' />
                </div>
                <div className='relative md:col-span-2 '>
                    <div className='absolute bottom-8 left-4 bg-opacity-80'>
                ...
                <img src="/Images/Bitmap4.png" alt="Portfolio Item" className=' w-full h-60 md:h-80 object-cover rounded-lg shadow-lg' />
                </div>
               </div>
               ...
               <div className='m-8  bg-orange-50 grid grid-cols-1 md:grid-cols-3 p-4 space-x-3 rounded-lg'>
                <div className='relative text-left p-4 space-y-2'>
                    <img src="/Images/icon.png" alt="Get Started" className=' absolute -top-10 z-20 w-12 h-12 md:w-15 md:h-15 object-contain rounded-lg ' />
                ...
                <div className='flex justify-center items-center'>
                    <img src="/Images/block.png" alt="Get Started" className='w-25 h-25 object-cover rounded-lg ' />
                </div>
                <div className='md:relative flex justify-center items-center'>
                    <img src="/Images/path.png" alt="Get Started" className=' hidden md:absolute w-15 h-15  md:w-full  md:h-full md:object-contain rounded-lg ' />
                    <img src="/Images/Bitmap5.png" alt="Get Started" className=' md:absolute -top-10 z-20 w-25 h-25  md:w-full  md:h-full md:object-contain   object-cover rounded-lg ' />
                </div>
               </div>
